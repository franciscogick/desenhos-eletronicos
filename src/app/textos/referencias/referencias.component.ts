...
export class ReferenciasComponent implements OnInit {
  ...
  textName = 'referencias';
  textContainerId = 'texto-inner-referencias';
  ...
  constructor(private renderer: Renderer2, private highlightService: HighlightService, private sessionService: SessionService, private httpService: HttpService) { }
