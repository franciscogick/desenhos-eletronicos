...
@Component({
  selector: 'app-elit-teatro',
  templateUrl: './elit-teatro.component.html',
  styleUrls: ['./elit-teatro.component.css']
})
export class ElitTeatroComponent implements OnInit,AfterViewInit,OnDestroy {
  ...
  constructor(private renderer: Renderer2, private highlightService: HighlightService, private sessionService: SessionService,private scrollService: ScrollService) {
