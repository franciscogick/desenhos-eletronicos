...
export class DragDirective implements OnDestroy, OnInit, OnChanges, AfterViewChecked {
  ...
  constructor(
    ...
    this.mouseUpListener = renderer.listen(el.nativeElement, 'mouseup', this.onMouseUpHandler);
	  this.mouseLeaveListener = renderer.listen(el.nativeElement, 'mouseleave', this.onMouseLeave.bind(this));
  }
  ...
  private hideScrollbar(): void {
    if (this.el.nativeElement.style.display !== 'none') {
      ...
      this.wrapper.style.height = '25%';
      this.wrapper.style.overflow = 'hidden';
      this.el.nativeElement.style.width = `calc(25% + ${this.scrollbarWidth})`;
      this.el.nativeElement.style.height = `calc(25% + ${this.scrollbarWidth})`;
  ...
  private checkScrollbar() {
    if (this.el.nativeElement.scrollWidth <= this.el.nativeElement.clientWidth) {
      this.el.nativeElement.style.height = '25%';
    } else {
      this.el.nativeElement.style.height = `calc(25% + ${this.scrollbarWidth})`;
    }
